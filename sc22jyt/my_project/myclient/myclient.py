...
def logout():
    response = session.post('https://sc22jyt.pythonanywhere.com/myapp/api/logout')
...
def post_story():
    url = 'https://sc22jyt.pythonanywhere.com/myapp/api/stories'
...
def delete_story(command):
    ...
    url = f'https://sc22jyt.pythonanywhere.com/api/stories/{story_key}'
